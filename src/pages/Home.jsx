...
const navigation = [
  ...
  { name: 'Home', href: 'articles', current: true },
          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    ...
                    src="https://img.icons8.com/arcade/512/news.png"
                    alt="Your Company"
                  />
                  <img
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                {/* Profile dropdown */}
                <button className='btn btn-primary me-4' onClick={articleForm}>Add artcle</button>
                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <button
                            onClick={logoutBtn}
                            className={classNames(active ? 'bg-red-500' : '', 'block px-4 py-2 text-sm text-gray-700')}
                          >
                            Sign out
                          </button>
                        )}
